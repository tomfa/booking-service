...
import FormSubscribe from '../kit/FormSubscribe';
...
const Footer = (props: Props) => {
  const links: FooterLinks[] = useMemo(
    () => [
      {
  ...
  return (
    <footer className={`dark:bg-gray-800 w-full py-8 bg-sloth-dark`}>
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        {
          <div
            className={`text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center text-xs`}>
            © {new Date().getFullYear()} Vailable v. {config.CONFIG_BUILD_ID}
          </div>
        }
      </div>
    </footer>
